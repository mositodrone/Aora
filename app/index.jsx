...
const Welcome = () => {
  ...
  console.log('signed in status: ' + isLogged);
  console.log('load status: ' + isLoading);
    ...
    <SafeAreaView className="bg-primary h-full">
      <ScrollView contentContainerStyle={{ height: "100%" }}>
        <View className="w-full justify-center items-center min-h-[65vh] px-4">
          ...
          <Image 
            source={images.cards}
            className="max-w-380px w-full h-[200px] md:h-[300px]"
            resizeMode="contain"
          />
          ...
          <View className="relative mt-5">
            ...
            <Image 
              source={images.path}
              className="w-[136px] h-[15px] absolute -bottom-2 left-20"
              resizeMode="contain"
            />
          </View>
